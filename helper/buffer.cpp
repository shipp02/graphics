...
buffer::buffer(vector<float> &_points, vector<point_type> _types)
...
buffer::~buffer() { glDeleteBuffers(1, &_buffer); }
...
buffer::ptr buffer::with_bind_point(const program::ptr &p, string name,
