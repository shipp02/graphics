...
namespace gl {
auto DefaultTexture =
    tex_parameters{GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR};

void texture2dBind(GLuint arr) { glBindTexture(GL_TEXTURE_2D, arr); }

texture::texture(std::string path, GLenum activeTexture,
                 tex_parameters params) {
